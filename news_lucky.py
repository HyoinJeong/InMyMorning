...
def main_get(num=None):
    ...
    return render_template('main.html',char1=lucky_title, char2=lucky_content,category=category,category_len=len(category),content=all_result,link=all_link, num=1)
